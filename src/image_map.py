...
IMAGE_MAP: dict[str, tuple[int, str]] = {
    ...
    "common02icon": (4184, "Common02Icon.arc"),
    ...
    "dateedit01": (4190, "DateEdit01.arc"),
    "dateedit02": (4191, "DateEdit02.arc"),
    "dateedit03": (4192, "DateEdit03.arc"),
    "dateedit04": (4193, "DateEdit04.arc"),
    "dateedit05": (4194, "DateEdit05.arc"),
    ...
    "gameinfo": (5188, "GameInfo.arc"),
    "girlstalk": (5189, "GirlsTalk.arc"),
    "inputctexture": (5190, "InputCTexture.arc"),
    "inputntexture": (5190, "InputNTexture.arc"),
    # Boot / intro UI (CESA warning, name entry, etc.)
    "intro108": (5191, "Intro108.arc"),
    "intro111": (5192, "Intro111.arc"),
    "intro201": (5193, "Intro201.arc"),
    "intro203": (5194, "Intro203.arc"),
    "intro301": (5195, "Intro301.arc"),
    "intro304": (5196, "Intro304.arc"),
    "introcommon": (5197, "IntroCommon.arc"),
    "item": (5198, "Item.arc"),
    "itemselect": (5199, "ItemSelect.arc"),
    "localmatching": (5200, "LocalMatching.arc"),
    "lovelink": (5201, "LoveLink.arc"),
    ...
    "optionlock": (5250, "OptionLock.arc"),
    "optionpassword": (5251, "OptionPassword.arc"),
    ...
    "dateeditspotinfo": (5386, "DateEditSpotInfo.arc"),
    "gallery": (5394, "Gallery.arc"),
    "haircatalog": (5395, "HairCatalog.arc"),
