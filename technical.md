...
*Last updated 2026-09-16 — Gemini Nene machine pass marked unreviewed; §12.7 CESA companion + §21 Message Speed; UI PNG masters **1727** mapped / **562** chrome (`export_progress_metrics.py`); volunteer kit sizes in §20.2.*
