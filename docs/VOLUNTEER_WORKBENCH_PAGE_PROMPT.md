...
| **Images** | Audit **all** UI PNG masters: OK / Needs fix / upload fixed PNG | `NLPP_Translate_Images/` (+ optional `.zip`) | `nlpp-images-YYYY-MM-DD.json` (may include `png_b64`) | **1745** PNGs in **95 / 95** folders |
